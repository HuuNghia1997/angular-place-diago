...
@Component({
  selector: 'app-list-all-petition',
  templateUrl: './list-all-petition.component.html',
  styleUrls: ['./list-all-petition.component.scss'],
  providers: [
...
export class ListAllPetitionComponent implements OnInit, AfterViewInit {
  // Khởi tạo
  ...
  ELEMENTDATA: AllPetitionElement[] = [];
  dataSource: MatTableDataSource<AllPetitionElement>;
