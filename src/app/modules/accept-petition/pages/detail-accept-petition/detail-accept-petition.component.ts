...
export class DetailAcceptPetitionComponent implements OnInit {
  ...
  reporterLocationLat: string;
  reporterLocationLng: string;
  ...
  setViewData() {    
    ...
    this.reporterLocationLat =this.response[0].reporterLocation.latitude;
    this.reporterLocationLng = this.response[0].reporterLocation.longitude;
