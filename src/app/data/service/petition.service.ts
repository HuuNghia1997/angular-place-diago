...
export class PetitionService {
  ...
  public getPetitionUrl = this.apiProviderService.getUrl('digoMicroservice', 'rbPetition') + '/digo/task/';
  ...
  public taskUrl = this.apiProviderService.getUrl('digoMicroservice', 'rbPetition') + '/v1/tasks/';
  public nextFlowUrl = this.apiProviderService.getUrl('digoMicroservice', 'rbPetition') + '/digo/task/';
  public getPlaceUrl = this.apiProviderService.getUrl('digoMicroservice', 'basedata') + '/place?nation-id=';
  public commentUrl = this.apiProviderService.getUrl('digoMicroservice', 'messenger') + '/comment';
  public taskVariableUrl = this.apiProviderService.getUrl('digoMicroservice', 'rbPetition') + '/v1/tasks/';
