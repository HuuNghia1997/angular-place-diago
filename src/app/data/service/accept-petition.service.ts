...
export class AcceptPetitionService {
  ...
  // Connect API
  public getTags =
    this.apiProviderService.getUrl('digoMicroservice', 'basecat') +
    '/tag?category-id=';
  public getAgencyURL =
    this.apiProviderService.getUrl('digoMicroservice', 'basedata') +
    '/agency/name+logo-id?parent-id=&tag-id=';
  public searchURL =
    this.apiProviderService.getUrl('digoMicroservice', 'surfeed') +
    '/petition/--search?';
  public postURL =
    this.apiProviderService.getUrl('digoMicroservice', 'surfeed') +
    '/petition';
  public uploadFilesURL =
    this.apiProviderService.getUrl('digoMicroservice', 'fileman') +
    '/file/--multiple';
  public deleteFilesURL =
    this.apiProviderService.getUrl('digoMicroservice', 'fileman') + '/file/';
  public getDetailURL =
    this.apiProviderService.getUrl('digoMicroservice', 'surfeed') +
    '/petition/';
  public putURL =
  ...
  public getFileURL =
    this.apiProviderService.getUrl('digoMicroservice', 'fileman') + '/file/';
  public getHistory =
    this.apiProviderService.getUrl('digoMicroservice', 'logman') + '/lo'+
    '/history?group-id=';
  public getUserURL =
    this.apiProviderService.getUrl('digoMicroservice', 'human') +
    '/user/--search?keyword=';
  ...
  public getProcessDefinitionsURL =
    this.apiProviderService.getUrl('digoMicroservice', 'rbPetition') +
    '/v1/process-definitions/';
  public getComment =
    this.apiProviderService.getUrl('digoMicroservice', 'messenger') +
    '/comment?group-id=';
